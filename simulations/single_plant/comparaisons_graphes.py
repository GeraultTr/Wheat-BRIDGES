...
def photosynthesis(df_current_axes, df_marion_axes):
    ...
    axis.plot(df_marion_axes['day'].unique(), df_marion_axes.groupby('day')['Total_Photosynthesis'].sum(), label='Marion')
...
def roots(df_current_organs, df_marion_organs, tmin, tmax):
    ...
    axs[0, 0].plot(df_marion_organs[(df_marion_organs.organ == 'roots')]['t'], df_marion_organs[(df_marion_organs.organ == 'roots')]['Conc_Sucrose'], label='Marion')
    axs[0, 0].legend()
    axs[0, 0].set_xlim(tmin, tmax)
    axs[0, 0].set_ylabel('Concentration sucrose (µmol g-1)')
    ...
    axs[0, 1].plot(df_marion_organs[(df_marion_organs.organ == 'roots')]['t'], df_marion_organs[(df_marion_organs.organ == 'roots')]['sucrose'], label='Marion')
    axs[0, 1].legend()
    axs[0, 1].set_xlim(tmin, tmax)
    ...
    axs[1, 0].plot(df_marion_organs[(df_marion_organs.organ == 'roots')]['t'], df_marion_organs[(df_marion_organs.organ == 'roots')]['Conc_Nitrates'], label='Marion')
    axs[1, 0].legend()
    axs[1, 0].set_xlim(tmin, tmax)
    # axs[1, 0].set_ylim(0, 200)
    ...
    axs[1, 1].plot(df_marion_organs[(df_marion_organs.organ == 'roots')]['t'], df_marion_organs[(df_marion_organs.organ == 'roots')]['Conc_cytokinins'], label='Marion')
    axs[1, 1].legend()
    axs[1, 1].set_xlim(tmin, tmax)
...
def surface(df_current_elements, df_marion_elements, tmin, tmax):
    ...
    axs[0, 0].plot(df_marion_elements['t'].unique(), df_marion_elements.groupby('t')['green_area'].sum(), label='Marion')
    axs[0, 0].legend()
    axs[0, 0].set_xlim(tmin, tmax)
    ...
    axs[0, 1].plot(df_marion_elements_blade['t'].unique(), df_marion_elements_blade.groupby('t')['green_area'].sum(), label='Marion')
    axs[0, 1].legend()
    axs[0, 1].set_xlim(tmin, tmax)
    ...
    axs[1, 0].plot(df_marion_elements_sheath['t'].unique(), df_marion_elements_sheath.groupby('t')['green_area'].sum(), label='Marion')
    axs[1, 0].legend()
    axs[1, 0].set_xlim(tmin, tmax)
    ...
    axs[1, 1].plot(df_marion_elements_internode['t'].unique(), df_marion_elements_internode.groupby('t')['green_area'].sum(), label='Marion')
    axs[1, 1].legend()
    axs[1, 1].set_xlim(tmin, tmax)
...
def leaf_length_mstruct_area(df_current_hz, df_marion_hz, df_current_elements, df_marion_elements, tmin, tmax):
    ...
    for phyto_id in df_current_hz['metamer'].unique():
        ...
        if phyto_id in (1,2):
            axs[0][0].plot(df_marion_elements[(df_marion_elements.metamer == phyto_id)]['t'].unique(), df_marion_elements[(df_marion_elements.metamer == phyto_id)].groupby('t')['length'].sum(), color='orange', label='Marion')
        else:
            axs[0][0].plot(df_marion_hz[(df_marion_hz.metamer == phyto_id)]['t'], df_marion_hz[(df_marion_hz.metamer == phyto_id)]['leaf_L'], color='orange', label='Marion')
        axs[0][0].set_xlim(tmin, tmax)
        ...
        axs[0][1].plot(df_marion_elements[(df_marion_elements.metamer == phyto_id) & (df_marion_elements.organ == 'sheath')]['t'].unique(), df_marion_elements[(df_marion_elements.metamer == phyto_id) & (df_marion_elements.organ == 'sheath')].groupby('t')['length'].sum(), color='orange', label='Marion')
        axs[0][1].set_xlim(tmin, tmax)
        ...
        if phyto_id in (1, 2):
            ...
            axs[1][0].plot(df_marion_hz[(df_marion_hz.metamer == phyto_id)]['t'], df_marion_hz[(df_marion_hz.metamer == phyto_id)]['mstruct'], color='orange', label='Marion')
        axs[1][0].set_xlim(tmin, tmax)
        ...
        axs[1][1].plot(df_marion_elements[(df_marion_elements.metamer == phyto_id) & (df_marion_elements.organ == 'blade')]['t'].unique(), df_marion_elements[(df_marion_elements.metamer == phyto_id) & (df_marion_elements.organ == 'blade')].groupby('t')['mstruct'].sum(), color='orange', label='Marion')
        axs[1][1].set_xlim(tmin, tmax)
        ...
        axs[2][0].plot(df_marion_elements[(df_marion_elements.metamer == phyto_id) & (df_marion_elements.organ == 'sheath')]['t'].unique(), df_marion_elements[(df_marion_elements.metamer == phyto_id) & (df_marion_elements.organ == 'sheath')].groupby('t')['mstruct'].sum(), color='orange', label='Marion')
        axs[2][0].set_xlim(tmin, tmax)
        axs[2][0].set_ylabel('Sheath mstruct' + ' (g)')

        ax2 = axs[2][0].twiny()
        ax2.set_xticks(axs[2][0].get_xticks())
        ax2.set_xticklabels(meteo_data.loc[axs[2][0].get_xticks()]['Date'].dt.strftime('%d/%m'))
        ax2.xaxis.set_ticks_position('bottom')  # set the position of the second x-axis to bottom
        ax2.xaxis.set_label_position('bottom')  # set the position of the second x-axis to bottom
        ax2.spines['bottom'].set_position(('outward', 35))
        ...
        ax2.set_xticklabels(meteo_data.loc[axs[2][1].get_xticks()]['Date'].dt.strftime('%d/%m'))
        ax2.xaxis.set_ticks_position('bottom')  # set the position of the second x-axis to bottom
        ax2.xaxis.set_label_position('bottom')  # set the position of the second x-axis to bottom
        ax2.spines['bottom'].set_position(('outward', 35))
        ...
        axs[0][2].plot(df_marion_hz[(df_marion_hz.metamer == phyto_id)]['t'], Marion_internode_L, color='orange', label='Marion')
...
def plastochrone(df_current_axes, df_marion_SAMS):
    fig, axis = plt.subplots()
...
if __name__ == '__main__':
    ...
    simulation_name = "WB_R22"
    path = os.getcwd()
    POSTPROCESSING = os.path.join(path, simulation_name, "MTG_properties/shoot_properties")
    GRAPHS = os.path.join(path, 'graphs')

    # Path Marion
    dirpath_marion = r'~/package/Wheat-BRIDGES/simulations/single_plant/Gauthier_2020_JExpBot/Soumission_JXBot'
