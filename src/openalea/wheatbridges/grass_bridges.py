...
class GrassBRIDGES(CompositeModel):
    ...
    def __init__(self, queues_soil_to_plants, queue_plants_to_soil, 
        ...
        self.shoot = CNW_Grass(root_mtg=self.g_root, computing_light_interception=False, **scenario_utility(time_step_in_seconds=time_step, INPUTS_DIRPATH="inputs", stored_times="all", 
                                                    isolated_roots=True, cnwgrass_roots=False, single_plant=True, hydraulics=True, update_parameters_all_models=parameters))
